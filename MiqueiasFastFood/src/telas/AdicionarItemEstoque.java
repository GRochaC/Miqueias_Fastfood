 ...
 * @author caleb
 */
public class AdicionarItemEstoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quantidade do item: ");

        jLabel3.setFont(new java.awt.Font("sansserif", 1, 24)); // NOI18N
        jLabel3.setText("Adicione um item");
        ...
        jPanel2.setBackground(new java.awt.Color(180, 82, 82));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Estoque.adicionarItem(jTextField1.getText(), (int) jSpinner1.getValue());
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(AdicionarItemEstoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
